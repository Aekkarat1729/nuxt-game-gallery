...
import { o as parseQuery, q as hasProtocol, v as isScriptProtocol, w as joinURL, x as withQuery, y as sanitizeStatusCode, z as withTrailingSlash, A as withoutTrailingSlash, B as getContext, c as createError$1, $ as $fetch$1, C as baseURL, D as defu, E as defuFn, F as klona, G as createDefu, H as isEqual, I as diff, J as createHooks, K as executeAsync, L as toRouteMatcher, M as createRouter$1 } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CBBOO_J3.mjs')
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-d_Srblho.mjs')
  },
  {
    name: "register",
    path: "/register",
    component: () => import('./register-BzBtwQx6.mjs')
  },
  {
    name: "user-deal",
    path: "/user/deal",
    component: () => import('./deal-BixJfCdB.mjs')
  },
  {
    name: "user",
    path: "/user",
    component: () => import('./index-DOrZELAi.mjs')
  },
  {
    name: "admin",
    path: "/admin",
    component: () => import('./index-DZtBE1IG.mjs')
  },
  {
    name: "user-wishlist",
    path: "/user/wishlist",
    component: () => import('./wishlist-DeITtw5E.mjs')
  },
  {
    name: "detail-slug",
    path: "/detail/:slug(.*)*",
    component: () => import('./_...slug_-DS2QkJFP.mjs')
  },
  {
    name: "admin-DealManagement",
    path: "/admin/DealManagement",
    component: () => import('./DealManagement-oGsWy_SZ.mjs')
  },
  {
    name: "admin-GameManagement",
    path: "/admin/GameManagement",
    component: () => import('./GameManagement-9WG_azYc.mjs')
  }
];
...
const __nuxt_component_0$4 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$8, [["ssrRender", _sfc_ssrRender$5]]), { __name: "UIcon" });
...
const __nuxt_component_1$1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$7, [["ssrRender", _sfc_ssrRender$4]]), { __name: "UAvatar" });
...
const __nuxt_component_0$2 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$6, [["ssrRender", _sfc_ssrRender$3]]), { __name: "ULink" });
...
const __nuxt_component_2 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$5, [["ssrRender", _sfc_ssrRender$2]]), { __name: "UButton" });
...
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender]]), { __name: "UNotifications" });
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: ["bg-black min-h-[100dvh] overflow-x-auto relative", { "flex flex-col md:block": _ctx.$router.currentRoute.value.fullPath !== "/" }]
      }, _attrs))}>`);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BFbrgFUO.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BQcmISNT.mjs'));
