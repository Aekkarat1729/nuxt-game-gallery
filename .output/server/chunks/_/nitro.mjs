...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "3383b68a-1b42-47d8-878a-6b90ba23457c",
  ...
  "public": {
    "apiBase": "https://gamedeal-back.onrender.com"
  },
  "icon": {
  ...
  "session": {
    "name": "nuxt-session",
    "password": "d3c9a1c754154fc28c2b9dc45f678a8e",
    "cookie": {
      "sameSite": "lax"
    }
  },
...
const _9x6UzbbEPUEDQ6X51T7TGuwsBEZB_6amyOdYFLB7TnE = defineNitroPlugin((nitroApp) => {
...
const _a6Vv0ikcLo6ZFiVt9vyfqFY6HBPEnPhQ4f6aW9V9Q = (function(nitro) {
...
const plugins = [
  _9x6UzbbEPUEDQ6X51T7TGuwsBEZB_6amyOdYFLB7TnE,
_a6Vv0ikcLo6ZFiVt9vyfqFY6HBPEnPhQ4f6aW9V9Q
];
...
const _UyIvtd = defineCachedEventHandler(async (event) => {
...
const _7Zd23Z = eventHandler(async (event) => {
  await clearUserSession(event);
  return { loggedOut: true };
});

const _525tdH = eventHandler(async (event) => {
...
const _z3SBDw = lazyEventHandler(() => {
...
const _lazy_tmLP56 = () => import('../routes/api/auth.post.mjs');
const _lazy_7zA0xl = () => import('../routes/api/images/_pathname_.delete.mjs');
const _lazy_cdVB8k = () => import('../routes/api/images/_pathname_.get.mjs');
const _lazy_mH_5K_ = () => import('../routes/api/index.get.mjs');
const _lazy_8JebXt = () => import('../routes/api/images/upload.post.mjs');
const _lazy_ipOjex = () => import('../routes/images/_pathname_.get.mjs');
const _lazy_uALZVd = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/api/auth', handler: _lazy_tmLP56, lazy: true, middleware: false, method: "post" },
  { route: '/api/images/:pathname', handler: _lazy_7zA0xl, lazy: true, middleware: false, method: "delete" },
  { route: '/api/images/:pathname', handler: _lazy_cdVB8k, lazy: true, middleware: false, method: "get" },
  { route: '/api/images', handler: _lazy_mH_5K_, lazy: true, middleware: false, method: "get" },
  { route: '/api/images/upload', handler: _lazy_8JebXt, lazy: true, middleware: false, method: "post" },
  { route: '/images/:pathname', handler: _lazy_ipOjex, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_uALZVd, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _UyIvtd, lazy: false, middleware: false, method: undefined },
  { route: '/api/_auth/session', handler: _7Zd23Z, lazy: false, middleware: false, method: "delete" },
  { route: '/api/_auth/session', handler: _525tdH, lazy: false, middleware: false, method: "get" },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _z3SBDw, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_uALZVd, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, withoutTrailingSlash as A, getContext as B, baseURL as C, defu as D, defuFn as E, klona as F, createDefu as G, isEqual as H, diff as I, createHooks as J, executeAsync as K, toRouteMatcher as L, createRouter$1 as M, toNodeListener as a, requireUserSession as b, createError$1 as c, getValidatedRouterParams as d, eventHandler as e, buildAssetsURL as f, getUserSession as g, useRuntimeConfig as h, getResponseStatusText as i, getResponseStatus as j, defineRenderHandler as k, getQuery as l, destr as m, getRouteRules as n, parseQuery as o, publicAssetsURL as p, hasProtocol as q, readBody as r, setUserSession as s, trapUnhandledNodeErrors as t, useNitroApp as u, isScriptProtocol as v, joinURL as w, withQuery as x, sanitizeStatusCode as y, withTrailingSlash as z };
